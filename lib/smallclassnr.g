...
##
SCN_ConditionList := function( arg... )
    local fnc, vls, i;
    fnc := [];
    vls := [];
    i := 1;
...
##
SCN_ExtractClassNumbers := function( fnc, vls )
    local pos, kGs;
...
##
SCN_NextSmallClassNrGroup := function( itr )
...
##
SCN_IsDoneIterator := function( itr )
    local nxt;
